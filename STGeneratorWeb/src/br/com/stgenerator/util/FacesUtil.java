...
public class FacesUtil {
	...
	public static Object removeApplication(String label) {
		return FacesContext.getCurrentInstance().getExternalContext()
	...
	public static void addMessage(String clientId, String key,FacesMessage.Severity severity) {
		FacesMessage message = getMessage(key, severity);
		FacesContext.getCurrentInstance().addMessage(clientId, message);
	}
	
	private static FacesMessage getMessage(String key,FacesMessage.Severity severity) {
